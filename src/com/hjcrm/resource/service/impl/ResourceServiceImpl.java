...
public class ResourceServiceImpl implements IResourceService{
	...
	public List<Resource> queryResourceTodayCount(String userid,String deptid,String roleid,Resource resource) {
		...
		if (resource != null) {
			...
			param.put("yunYingResourceLevel", resource.getYunYingResourceLevel() != null && !"".equals(resource.getYunYingResourceLevel()) ?resource.getYunYingResourceLevel():null);//运营资源等级   
